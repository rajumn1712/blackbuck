...
const JobDetails = () => {
  ...
  return (
    <>
      <a className="f-16 semibold mx-4 text-primary">
      ...
      <div className="custom-card mt-12">
        <Card>
          <div className="p-12">
            ...
            <p className="f-14 text-primary mb-12 job-req">
              <span className="post-icons job mr-16"></span>3 Yr's
            </p>
            <p className="f-14 text-primary mb-12 job-req">
              <span className="post-icons role mr-16"></span>2 LPA
            </p>
        ...
        <Card title="Job Description" bordered>
          <div className="p-12">
            ...
            <Paragraph className="f-14 text-primary semibold">Internship</Paragraph>
      ...
      >
        ...
        <Dragger
          ...
          <div className="custom-fields">
            <label className="semibold text-secondary">Skills</label>
            <Input />
          </div>
          <div className="custom-fields">
            <label className="semibold text-secondary">Comment</label>
            <Input />
          </div>
        </Form>
      </Modal>
