...
<Card key={indx}
        ...
        >
          <div className="p-16">
            ...
            <ul className="d-flex m-0 pl-0 job-req">
              <li className="f-14 text-primary">
                ...
                <div>
                    ...
                    <Paragraph className="f-14 text-primary m-0">{jobpost.Type}</Paragraph>
                </div>
              </li>
              <li className=" f-14 text-primary ">
                ...
                <div>
                    ...
                    <Paragraph className="f-14 text-primary m-0">{jobpost.Title}</Paragraph>
                </div>
              </li>
              <li className="f-14 text-primary">
            ...
            <span className="job-ldate f-12 text-secondary px-8 py-4">Last date | <span className="semibold text-primary"><Moment format="MM/DD/YYYY">{jobpost.EndDate}</Moment></span></span>
          </div>
        </Card>
      )
    ...
    return (
      <div className="post-card" onScroll={handleScroll}>
        {/* <Card className="mb-8">
          <div className="p-16">
            <Title className="f-16 semibold text-primary mb-0">
                UI/UX Designer
