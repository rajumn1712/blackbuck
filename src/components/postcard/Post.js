        ...
        return (
            <div>
                ...
                >
                    ...
                    <div className="p-16">
                        <Title level={5} className="f-14">Do you miss seeing the friendly faces of your fellow Colony Brands’ employees?</Title>
                        <Paragraph className="f-12">Although social distancing has created many changes with CBU courses, we are still offering a
