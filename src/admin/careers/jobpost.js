              ...
              <Card className="custom-card" bordered={false}>
                <Row gutter={16}>
                  ...
                  <Col xs={24} sm={6}>
                    ...
                    <Form.Item className="custom-fields" name="Years">
                      <Input
                        placeholder="Years"
                  ...
                  {jobPostingObject.Type === "Internship" && (
                    <Col xs={24} sm={6}>
                      ...
                      <Form.Item className="custom-fields" name="Months">
                        <Select
                          defaultValue=""
                          className="text-left"
                  ...
                  <Col xs={24} sm={12} className="multi-select custom-fields">
                    <div className="upload-image">
                      ...
                      {jobPostingObject.CompanyLogo && (
                        <div className="mb-16 mt-8 upload-preview">
                          <Image
